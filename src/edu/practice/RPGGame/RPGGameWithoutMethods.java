...
public class RPGGameWithoutMethods {
    ...
    public static void main(String[] args) {
        ...
        // 전사 등급 계산
        String warriorRank = grade(warriorPower);
        System.out.println("전투력: " + warriorPower + " → 등급: " + warriorRank);
    ...
    public static String grade(int warriorPower) {
        if (warriorPower >= 200) return "전설급";
        else if (warriorPower >= 150) return "영웅급";
        else if (warriorPower >= 100) return "고수급";
        else return "초보급";
    }
}
