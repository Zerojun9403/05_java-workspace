...
public class VariableEx2 {
    ...
    public static void main(String[] args) {
        ...
        *
        *  ** 형변환 **
        *  - 다른 자료형 끼리 연산하는 경우 자료흥을 맞게 변환
        *
        *
        *    ** 자동 형변환 **
        *    - 연산시 값의 범위가 작은 자료형을 값의 범위가 큰 자료형으로 맞추어 변환 -
        *
        *
        * */
        ...
        /*
        * int result2 = nu1+num2;
        * 필요한 타입: int
        * 제공된 타입: long
        * 자동으로 형 변환 되어 result 2 는 long 값을 지니지만
        * int 형 크기의 바구니에 long 크기를 넣으려 해서 오류 발생
        *
        * 데이터를 담는 바구니 크기보다 데이터가 커서 발생하는 문제
        *
        *
        * */
