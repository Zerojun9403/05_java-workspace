...
public class AccountRun {
   //JVM 바라보는 메인 메서드 args의 매개변수 이름은 변경해도 되지만 나머지는 그대로 유지
    ...
    public static void main(String[] args) {
        ...
        //private  이 설성된 값과 안된 값 접근 가능 여부 확인

        //private 을 적용한 변수(필드)는 외부에서 보이지 않음(정보 은닉)

        // a1.accountNumber = "1234";
        // Account 클래스 내부에서 작성된 속성변수이름 accountNumber 는 private 형태이기 때문에
        ...
        // 간접 접근 기능을 이용해서 객체 내부에 저장되어 있는 데이터를 출력
         a1.getName(); // set 으로 저장한 데이터를 가져오기
        // getName 은 가져오는 것이지 가져오는 것을 출력하는 메서드가 아님
        // getName으로 가져온 데이터를 확인하기 위해서는  System 과 같은 출력문 내부에 작성해야함
        System.out.println(a1.getName());
        a1.setAccountNumber("123-456-789");
        a1.setPassword("7890");
        /*
        Account class 에서 accountNumber를 String
        자료형으로 작성한다 표기했기 떄문에
        private String accountNumber;

        데이터를 저장하는 것 또한 String 형태이어여함
        a1.setAccountNumber("123-456-789");
        ...
        */
        ...
        // 매개변수를 작성한 공간으로 Account() 소괄호 내부에 작성한 매게변수 순서대로 데이터작성
        // 데이터 순서가 일치하지 않으면 애러 발생
        ...
        // 각 계좌에 입금
        // 우리의 계좌 잔액에서 long 타입 정도의 숫자 금액이 들어올 수 있을지는 모르겠지만
        // 데이터 문제 발생을 최소화 하기 위해 long 작성

        a1.deposit(10000); // 변수에서 자료형이 long
        a1.deposit(12345L); // 데이터를 long 타입으로 저장하겠다.
        ...
        a1.withdraw("1234",20000); // 비밀번호 불일치
        a1.withdraw("7890",20000); // 잔액이 부족
