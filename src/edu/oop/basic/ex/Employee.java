...
public class Employee {
     ...
     * 근무년수 3년 이상 승진 기능
     * checkPromotion if
     * ㅇㅇ 님은 근무년수 ㅇㅇ년으로 승진 대상자 입니다.
     * 3년 이하 ㅇㅇ님은 근무년수 ㅇㅇ년으로 승진까지 00년 더 필요 합니다.
     *
     * - 캡슐화 원칙대로 수행
     *   System.out.printf("%s님은 근무년수 %d 년으로 승진대상자 입니다.\n", Name(), WorkYears());
     *
     * - 캡슐화 원칙 위배하여 수행
     *    System.out.printf("%s님은 근무년수 %d 년으로 승진대상자 입니다.\n", getName(), getWorkYears());
     *
     * 추후에는 속성만 작성해놓은 클래스 와
     * 속성을 활용한 기능을 작성해 놓은 클래스 와
     * 속성과 기능을 활용해서 실행하는 클래스 나뉨
     *
     * 위에 작성한 System 구문이 모두 가능하지만 추후 미래를 위하여 get변수이름() 형식으로 작성하는 습관을 잦고 있는것이 좋음
     *
     * */
    public void checkPromotion() {
        if (workYears >= 3)
            ...
            System.out.printf("%s님은 근무년수 %d 년으로 승진까지 %d년 더 필요합니다\n", getName(), getWorkYears(), (3-getWorkYears()));
    ...
    * */
     ...
     * 상세정보 를 출력하는 기능
     * 자바 자체에 존재하는 기능
     * @return String 문자열 형태로 회사원의 모든 정보 를 전달해서 출력
     *
