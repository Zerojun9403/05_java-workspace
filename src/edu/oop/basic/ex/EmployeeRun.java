...
public class EmployeeRun {
    ...
    public static void main(String[] args) {
        ...
        //
        /*
        * Employee 에 존재하지 않는 매개변수 생성자를 호출하면
        * Employee emp2 = new Employee("박기획","기획팀");
        * ↓ 아래와 같이 생성자를 해결할 수 없습니다와 함께
        * 생성자 'Employee emp2 = new Employee("박기획","기획팀")'을(를) 해결할 수 없습니다.
        ...
        * */
        ...
        Employee emp2 = new Employee("박기획", "기획팀", "대리", "PLN002");
        // 회원가입을 할 떄 필수로 작성해야하는 매개변수들 필수로 데이터 저장해야하는 값들을 담은 변수 명칭
        emp2.setAge(32);
        emp2.setSalary(5200);
        emp2.setWorkYears(5);
        ...
        emp3.setSalary(3800);
        emp3.setWorkYears(1);
        System.out.println("===== 전직원 상세 정보 =====");

        //Employee  직원들 중에서 emp1 직원 1번에 대한 정보를 출력
        // emp1 변수이름에는 Employee 클래스 작성한 메서드 기능들을 사용할 수 있음
        // @Override ( 기존에 존재하는 기능을 재수정해서 사ㅣ용 표기가 없어도 정상 작동 / 재사용한다는 표기)
        // public class Employee{ public String toString(){}}
