...
public class GuestHouseRun {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("guest1 이 보이는 총 방문자 수 : " + guest1.totalCount); //GuestHouse.totalCount
        // 32번 째 줄에서 실행 한 방문자 수는
        // 게스트 1번 사람만 보이는 방무자 수가 아니라 GuestHouse 클래스에서 자체적으로
        // 모든 게스트 하우스 사람들에게 제공하는 숫자이므로
        // 40번째 줄에서 보이는 총 방문자 수는 guest1, guest2 모두 방문한 카운트가 보이는것이 맞음
        ...
        // 올바른 static 접근 방식
        System.out.println("guest2 이 보이는 총 방문자 수 : " + GuestHouse.totalCount);
