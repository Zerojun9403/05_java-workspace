...
public class GuestHouse {
    ...
    public static int totalCount = 0; // 전체 방문자 수 (모든 방문자 공유)
    ...
    public static final int MAX_STAY_DAY = 30;
    public static final int MIN_STAY_DAY = 10;


    private String guestName; //방문자명
    private String checkInDate; //체크인 시간
    ...
    // -> static 최초 1회만 읽음
    static {
        totalCount = 0; // 시스템 시작시 방문자 수 초기화
    ...
    public void guestInfo() {
        System.out.println("==============");
        System.out.println("방문자 명 : " + guestName);
