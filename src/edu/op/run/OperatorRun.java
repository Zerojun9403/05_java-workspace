...
public class OperatorRun {
    // static 이 작성된 긴으이나 변수이름 메모리에서 프로그램을 사용할때 상시사용처럼
    // 메모리공간을 차지하는 예약어
     ...
     *  Heap( 창고지기)
     *  - Stack 에서 주소값으로 연결되어 들어가면 존재하는 실제 물건들의 우치
     *  - 누군가 클래스로 만들어진 객체를 사용하면 보관, 사용하지 않으면 창고 공간을 차지하는 불필요한 갹체 나 기능으로 판단하여 버림
