...
public class ListService {
   ...
   LinkedList : 서로 연결된 링크 형태의 리스트(기차)
    ...
    대부분   의 경우에는 ArrayList 를 주로 사용
    LinkedList  경우에는 중간에 삽입 / 삭제가 정~~~말 많을 때만 사용
                         확실한 이유가 있을 때만 사용
    ...
    public void bookManage(){
        ...
        List<Book> bookList = new LinkedList<>(); // 중간에 삽입 삭제가 무수히 많을경우 주로 사용
            ...
            switch (input){
                ...
                case 2:
                    ...
                    if (bookList.size() > 0) {
                        ...
                        // for 문 다형성에서 작성했던 것처럼 향상된 for문 활용하기
