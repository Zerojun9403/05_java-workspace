...
public class MenuOrderRun {
    ...
    public static void menuOrder() {
        ...
        // 메뉴 5개 추가해주세요
        menuList.add(0,"빅맥");
        menuList.add(1,"상하이버거");
        menuList.add(2,"치킨버거");
        menuList.add(3,"새우버거");
        menuList.add(4,"불고기버거");

        // TODO: 2단계 - 주문 리스트 만들기
        List<String> orderList = new ArrayList<>();
        Scanner sc = new Scanner(System.in);
        int choice = 0;
         orderList.add(String.valueOf(choice));
        ...
        while(true) {
            ...
            switch(choice) {
                ...
                case 2:
                    ...
                    if (orderNum >= 1 && orderNum <= menuList.size()) {
                        String orderMenu = menuList.get(orderNum - 1); // 인덱스는 0부터 시작
                ...
                case 4:
                    ...
                    if (orderList.contains(cancelMenu)) {
                        orderList.remove(cancelMenu);  // 해당 메뉴 삭제
