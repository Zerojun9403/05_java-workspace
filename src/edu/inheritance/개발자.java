...
// 상속 키워드 : extends (확장하다)
//               -> 부모 코드를 자식이 물려받아 자식의 크기가 증가(코드가 증가한다는 의미)
public class 개발자 extends 직원 {
    ...
    public 개발자(String eName, int eId, double baseSalary, String department, String computer) {
        ...
        this.computer = computer; // this 를 여러번 작성할 필요없이 직원 클래스에 1번만 작성하고
    ...
    @Override // 직원클래스에서 작성한 기능을 참고해서 개발자 클래스가 원하는 기능으로 재활용
    public void info() {
        /*
        *
        * public void info(){
        ...
        System.out.println("부서 : " + getDeparment());
